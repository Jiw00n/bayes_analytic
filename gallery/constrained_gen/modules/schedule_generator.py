...
제약 목록:
  ...
  5) max_vthread
  6) max_innermost_split
  7) split_structure
  8) min_thread_extent (optional heuristic)
"""
import re
...
class ScheduleGenerator:
    ...
    VAR_ORDER_PHASE_FAMILIES = (
        ...
        (
            ...
            'execution: max_vthread/max_threads_per_block',
        ),
    ...
    def _materialize_assignment_state(self, sym_map=None):
        ...
        try:
            ...
            for name in effective_var_order:
                ...
                candidates = self._enumerate_split_candidates(name, remaining)
                if name in self._innermost_names:
                    candidates = [
