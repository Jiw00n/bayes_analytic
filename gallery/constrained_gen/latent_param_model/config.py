...
DEFAULT_CHECKPOINT_DIR = "/root/work/tvm-ansor/gallery/constrained_gen/latent_param_model/checkpoints_latent_param"
...
class TrainConfig:
    ...
    order_nce: bool = True
    prefix_corruption_start_epoch: int = 4
    prefix_corruption_warmup_epochs: int = 12
    prefix_corruption_max_sample_prob: float = 0.7
    prefix_corruption_max_block_len: int = 6
    prefix_corruption_prefix_param_count: int = 16
