...
def build_schedule_generator(task, state, base_inp=None, base_res=None):
    ...
    return ScheduleGenerator(
        ...
        base_state=state if base_inp is None or base_res is None else None,
    )


def build_schedule_generator_from_state(task, state):
    return build_schedule_generator(task, state, base_inp=None, base_res=None)
